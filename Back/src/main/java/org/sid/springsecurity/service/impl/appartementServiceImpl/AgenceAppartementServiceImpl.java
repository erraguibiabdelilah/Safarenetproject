...
public class AgenceAppartementServiceImpl implements AgenceAppartementService {
    ...
    public int save(AgenceAppartement agenceAppartement) {
        ...
        agenceAppartement.setLogo(null);
    ...
    public int update(AgenceAppartement propAppartemenet) {
        ...
        agenceAppartement.setLogo(propAppartemenet.getLogo());
    ...
    @Override
    public List<ImageModule> getImagesByIceAgApp(String username) {
        AgenceAppartement agenceAppartement = agenceAppartementDao.findByUsername(username);
        if (agenceAppartement != null) {
            return new ArrayList<>(agenceAppartement.getLogo());
        }
        return Collections.emptyList();
    }

    @Override
    public List<ImageModule> getImagesByIceAgApp(Long iceAgApp) {
        return null;
    }
}
