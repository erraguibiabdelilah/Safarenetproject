...
export class CategoriesAppartementService {
  ...
  public save(): Observable<number> {
    return this.http.post<number>("http://localhost:8085/api/categoriesAppartemen/", this.item);
  }

  public getAll():Observable<Array<CategoriesAppartement>>{
    return this.http.get<Array<CategoriesAppartement>>("http://localhost:8085/api/categoriesAppartemen/");
  }
