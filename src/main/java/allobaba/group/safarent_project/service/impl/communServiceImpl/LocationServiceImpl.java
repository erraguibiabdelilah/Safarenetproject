...
public class LocationServiceImpl implements LocationService {
    ...
    public LocationServiceImpl( LocationDao locationDao,@Lazy FactureService factureService,@Lazy ContratService contratService, ReservationService reservationService) {
